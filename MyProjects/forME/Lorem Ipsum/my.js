...
btn.addEventListener('mousedown', function(e){
    ...
    e.target.addEventListener('mouseup', function(e){
        e.target.style.background = "rgb(88, 88, 226)";
    })
})
...
btn.addEventListener('submit', function(e){
    ...
    loremText.appendChild(div);

    for(i = inputValue; i < 10; i++){
        console.log('elo')
    }

    switch (e) {
        case inputValue == 1:
            loremText.appendChild(div).innerHTML = 'h1';
            loremText.appendChild(div).innerHTML = 'h2';
    }
